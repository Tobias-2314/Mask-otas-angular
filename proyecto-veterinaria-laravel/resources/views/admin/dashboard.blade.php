    ...
    <div class="container mx-auto px-4">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <a href="{{ route('admin.usuarios') }}" class="flex items-center p-4 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition">
                ...
                <a href="{{ route('admin.citas') }}" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition">
                ...
                <a href="{{ route('admin.resenas') }}" class="flex items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition">
