...
<div class="container mx-auto px-6 py-12">
    <div class="text-center mb-16">
        ...
        <p class="text-gray-600 max-w-2xl mx-auto">Ofrecemos una gama completa de servicios veterinarios para garantizar la salud y felicidad de tu mascota.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden group hover:shadow-2xl transition">
            ...
            <div class="p-8">
                ...
                <p class="text-gray-600 mb-4">Chequeos rutinarios y diagnóstico integral para mantener a tu mascota en perfecto estado.</p>
                <a href="{{ route('citas.crear') }}" class="text-indigo-600 font-bold hover:underline">Agendar &rarr;</a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden group hover:shadow-2xl transition">
            ...
            <div class="p-8">
                ...
                <p class="text-gray-600 mb-4">Protege a tu mejor amigo contra enfermedades comunes con nuestro esquema de vacunación.</p>
                <a href="{{ route('citas.crear') }}" class="text-indigo-600 font-bold hover:underline">Agendar &rarr;</a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden group hover:shadow-2xl transition">
            ...
            <div class="p-8">
                ...
                <p class="text-gray-600 mb-4">Baños, cortes y tratamientos estéticos para que tu mascota luzca increíble.</p>
                <a href="{{ route('citas.crear') }}" class="text-indigo-600 font-bold hover:underline">Agendar &rarr;</a>
            </div>
        </div>
    </div>
