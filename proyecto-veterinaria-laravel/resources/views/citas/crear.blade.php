    ...
    <div class="max-w-2xl mx-auto bg-white rounded-2xl shadow-lg p-8">
        ...
        <form action="{{ route('citas.guardar') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm">
                        <span class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 sm:text-sm">
                            <select name="prefijo" class="bg-transparent border-none focus:ring-0 p-0 text-gray-700 h-full">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                ...
                <div class="col-span-2 mt-4">
                    ...
                    <input type="date" name="fecha_preferida" id="input_fecha" 
                           ...
                           oninput="seleccionarFecha(this.value)">
                    ...
                    <div id="time-slots" class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <p class="text-gray-500 text-sm italic col-span-2">Selecciona una fecha en el calendario para ver horarios.</p>
                    </div>
                </div>
            ...
            <div class="flex justify-end p-4">
                <button type="submit" class="bg-indigo-600 text-white px-8 py-3 rounded-full font-bold shadow-lg hover:bg-indigo-700 transition transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed" id="submit-btn" disabled>
                    Confirmar Cita
                </button>
            </div>
        </form>
