...
<div class="container mx-auto px-6 py-12">
        ...
        <form action="{{ route('resenas.guardar') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="flex gap-4">
                    <label class="cursor-pointer"><input type="radio" name="calificacion" value="5" checked class="mr-1"> ⭐⭐⭐⭐⭐</label>
                    <label class="cursor-pointer"><input type="radio" name="calificacion" value="4" class="mr-1"> ⭐⭐⭐⭐</label>
                    <label class="cursor-pointer"><input type="radio" name="calificacion" value="3" class="mr-1"> ⭐⭐⭐</label>
                </div>
            </div>

            <div class="mb-4">
                <label class="block text-gray-700 font-bold mb-2">Comentario</label>
                <textarea name="comentario" rows="3" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" required placeholder="Cuéntanos tu experiencia..."></textarea>
            </div>
    ...
    <div class="text-center">
        <p class="text-gray-600">¿Quieres dejar una reseña? <a href="{{ route('login') }}" class="text-indigo-600 font-bold hover:underline">Inicia sesión</a></p>
    </div>
    @endauth
</div>
@endsection
